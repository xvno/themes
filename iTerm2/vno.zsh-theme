...
local node_env='node-$(node --version)'
...
PROMPT="──${prompt_char}$FG[040]%n$reset_color@$FG[033]$(box_name) $terminfo[bold]$FG[226]${current_dir} $FG[200]${git_info} $FG[040]${node_env} $FG[033] ${go_version} $reset_color 
➤➤➤"
